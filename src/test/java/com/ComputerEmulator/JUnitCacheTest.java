...
public class JUnitCacheTest { 
    ...
    public void JUnitCacheTest0() throws Exception {
        ...
        testAssembler.assemble(new String[]{getResourcePath("cacheTest0Input.txt"), "cacheTest0Output.txt"});
    ...
    public void JUnitClockTest0() throws Exception {
        ...
        testAssembler.assemble(new String[]{getResourcePath("clockTest0Input.txt"), "clockTest0Output.txt"});
        MainMemory.load("clockTest0Output.txt");                                                                                                                                                                                     
        testProcessor.run();    
        Assert.assertEquals(110,testProcessor.getRegister(3).getSigned());                  // Clock cycles no cache:                                 36798                                                                                                                                                                                                                                                                                      
    ...
    public void JUnitClockTest1() throws Exception {
        ...
        testAssembler.assemble(new String[]{getResourcePath("clockTest1Input.txt"), "clockTest1Output.txt"});
        MainMemory.load("clockTest1Output.txt");                                                                                                                                                                                     
        testProcessor.run();    
        Assert.assertEquals(110,testProcessor.getRegister(4).getSigned());         // Clock cycles:                                          48238                                                                                                                                                                                                                                                                                      
    ...
    public void JUnitClockTest2() throws Exception {
        ...
        testAssembler.assemble(new String[]{getResourcePath("clockTest2Input.txt"), "clockTest2Output.txt"});
        MainMemory.load("clockTest2Output.txt");   
        testProcessor.run();    
        Assert.assertEquals(110,testProcessor.getRegister(3).getSigned());         // Clock cycles:                                          36798                                                                                                                                                                                                                                                                                      
    }                                                                                // Clock cycles instructionCache:                         7898
                                                                                     // Clock cycles instructionCache + L2(instructions only): 7998
